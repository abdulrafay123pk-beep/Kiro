...
class Board {
  ...
  piecesUpdate(moveIndex) {
    ...
    this.pieceIdsBlack.forEach((id) =>
      this.pieceCalculateMoves(id, moveIndex, this.state, this.piecePositions, this.piecesTilesCaptures, this.piecesTilesMoves, this.tilesPiecesBlackCaptures, this.tilesPiecesBlackMoves, this.resultingChecks.bind(this), this.kingCastles.bind(this))
    );
    this.pieceIdsWhite.forEach((id) =>
      this.pieceCalculateMoves(id, moveIndex, this.state, this.piecePositions, this.piecesTilesCaptures, this.piecesTilesMoves, this.tilesPiecesWhiteCaptures, this.tilesPiecesWhiteMoves, this.resultingChecks.bind(this), this.kingCastles.bind(this))
    );
...
class Game {
  ...
  activate(location) {
    ...
    if (tilePiece && !this.active && tilePiece.data.player !== this.turn) {
      ...
      this.activePieceOptions = [];
      const capturePiece = validatedPosition?.capture ? this.board.tileFind(validatedPosition.capture) : tilePiece;
